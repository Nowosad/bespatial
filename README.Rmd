...
This dataset contains 12 raster layers, where each has the equal number of cells with values 1 and 2 (identical compositions), but they are differently arranged in space (different configurations).
...
- it ends with the name of the author of the metric, for example, `cushman` or `gao`

```{r, echo=FALSE}
fun = c("`bes_m_cushman()`", "`bes_g_cushman()`", "`bes_g_gao()`", "`bes_p_cushman()`")
